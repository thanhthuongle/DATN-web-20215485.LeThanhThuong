          ...
          <List disablePadding >
            <ListItem disablePadding>
              ...
              <ListItemText
                ...
                secondary={ <Typography variant="body1" color="text.primary"> {moment(accumulation.startDate).format('DD/MM/YYYY')}&nbsp;-&nbsp;{moment(accumulation.enđate).format('DD/MM/YYYY')} </Typography> }
              />
            </ListItem>
