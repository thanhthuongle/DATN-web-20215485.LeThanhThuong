...
const workSpace = WORKSPACE.TCGD //or WORKSPACE.TCGD
  ...
  return (
    <Grid size={{ xs: 12, sm: 2.5 }}>
      <Stack direction="column" spacing={1}>
        ...
        {workSpace == WORKSPACE.TCGD && !isManager &&
          <SidebarItem>
            <SvgIcon fontSize='small'>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      {((workSpace == WORKSPACE.TCGD && isManager) || workSpace == WORKSPACE.TCCN) &&
      <>
        <Divider sx={{ my: 1 }} />
        <SidebarItem>
